...
if __name__=="__main__":
    preds = [[1, 6, 2, 7, 8, 3, 9, 10, 4, 5], [4, 1, 5, 6, 2, 7, 3, 8, 9, 10], [1, 2, 3, 4, 5] ]
    labels = [[1, 2, 3, 4, 5], [1, 2, 3], []]

    for k in [1, 5, 10]:
        print(f"Precision@{k}: {precision_at(preds, labels, k)}")
        print(f"MAP@{k}: {mean_average_precision_at(preds, labels, k)}")
        print(f"NGCD@{k}: {ndcg_at(preds, labels, k)}")
        # print(f"NGCD@{k}: {ndcg_at(preds, labels, k)}")
        print('-' * 10)

Precision@1: 0.3333333333333333
MAP@1: 0.3333333333333333
NGCD@1: 0.3333333333333333
----------
Precision@5: 0.26666666666666666
MAP@5: 0.2111111111111111
NGCD@5: 0.32878801226615906
----------
Precision@10: 0.26666666666666666
MAP@10: 0.35502645502645497
NGCD@10: 0.48791273434956867
----------
...
predictionAndLabels = spark.sparkContext.parallelize([
...
for k in [1, 5, 10]:
    ...
    print(f"MAP@{k}: {metrics.meanAveragePrecisionAt(k)}")
    print(f"NGCD@{k}: {metrics.ndcgAt(k)}")
    print('-' * 10)
...
Precision@5: 0.26666666666666666
MAP@5: 0.2111111111111111
NGCD@5: 0.3287880038045473
----------
Precision@10: 0.26666666666666666
MAP@10: 0.35502645502645497
NGCD@10: 0.48791274569166343
----------
"""